...
if Rails.env.development?
  ...
  seller = Seller.create(category: 110_011, active: true, seller_title: 'Content Creator', seller_name: 'Cool Clothes')
  user.sellers << seller
  ...
  seller = Seller.create(category: 666_666, active: true, seller_title: 'Content Creator', seller_name: 'TryHards Store')
  user.sellers << seller
  ...
  seller = Seller.create(category: 123_123, active: true, seller_title: 'Content Creator', seller_name: 'Blooprints Prints')
  user.sellers << seller
  ...
  seller = Seller.create(category: 111_222, active: true, seller_title: 'Content Creator', seller_name: 'Welyns Store')
  user.sellers << seller
